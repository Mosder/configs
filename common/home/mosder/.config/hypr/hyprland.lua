...
hl.define_submap('passthru', function() hl.bind('SUPER + P', hl.dsp.submap 'reset') end)
...
-- Volume controls
hl.bind('XF86AudioRaiseVolume', hl.dsp.exec_cmd(vars.osd .. '-client --output-volume raise --max-volume 95'), { locked = true, repeating = true })
hl.bind('XF86AudioLowerVolume', hl.dsp.exec_cmd(vars.osd .. '-client --output-volume lower'), { locked = true, repeating = true })
hl.bind('XF86AudioMute', hl.dsp.exec_cmd(vars.osd .. '-client --output-volume mute-toggle'), { locked = true, repeating = true })
hl.bind('XF86AudioMicMute', hl.dsp.exec_cmd(vars.osd .. '-client --input-volume mute-toggle'), { locked = true, repeating = true })
