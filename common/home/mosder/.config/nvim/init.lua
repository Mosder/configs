...
do
  ...
  -- Enable incrementation of letters
  ...
  vim.keymap.set('n', 'gre', function() vim.diagnostic.jump { count = 1 } end, { desc = 'Go to next diagnostic' })
...
do
  ...
  require('mini.ai').setup {
    ...
    custom_textobjects = {
      ...
      -- courtesy of https://github.com/bvngee
      -- `is` works fine `as` doesn't - cba to change this
      s = {
